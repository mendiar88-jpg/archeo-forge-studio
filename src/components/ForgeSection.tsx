...
const ForgeSection = () => (
  <section id="forge" className="py-24 bg-stone-dark">
    <div className="container mx-auto px-4 max-w-4xl">
      ...
      <p className="font-mono text-xs tracking-[0.2em] uppercase text-gold mb-12">Professional Experience</p>

      <div className="relative border-l border-border pl-8 space-y-16">
        {roles.map((role, i) => (
          <div key={i} className="relative">
            {/* Timeline dot */}
            <div className="absolute -left-[41px] top-1 w-3 h-3 border-2 border-gold bg-background rounded-full" />

            <p className="font-mono text-xs text-gold mb-1">{role.date}</p>
